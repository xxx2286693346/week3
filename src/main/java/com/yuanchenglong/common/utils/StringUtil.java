...
public class StringUtil {
	...
	public static char getChar() {
		...
		star=(176+Math.abs(random.nextInt(39)));
		end=(161+Math.abs(random.nextInt(93)));
		byte[] b = new byte[2];
		b[0]=(Integer.valueOf(star)).byteValue();
		b[1]=(Integer.valueOf(end)).byteValue();
		try {
	...
	public static String generateChineseName(){
		...
		char charAt = str.charAt(RandomUtil.random(0,str.length()-1));
		String string= charAt+randomChineseString(2);
		return string ;
	//TODO 实现代码
	}
}
